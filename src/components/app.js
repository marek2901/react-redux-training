...
class App extends React.Component {
  render() {
    var todos = _.map(this.props.todos, (element) => {
      return (<TodoItemResolver onToggle={this.toggleItem.bind(this)} onToggleEdit={this.toggleItemEdit.bind(this)} item={element} onEditCancel={this.itemEditCancel.bind(this)} onEditSubmit={this.itemEditSubmit.bind(this)} onDelete={this.itemDelete.bind(this)}/>);
    });

    return (<div className='umbotron d-flex align-items-center'>
